...
class InstructorForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'address': forms.Textarea(attrs={'class': 'w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 h-36 resize-y text-gray-800 bg-gray-50', 'placeholder': 'Street Address, City, State/Province, Postal Code'}),
